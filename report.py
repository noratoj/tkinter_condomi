...
class VentanaManejoRep(tkr.Toplevel):
    ...
    def __init__(self, parent, usu, *args, **kwargs):
        ...
        #self.lbl = Label(self.labelframe1, text="Buscar: ", bg=self.back1, fg=self.fore, font=self.tamagnoletra)
        ...
        #self.button2=tkr.Button(self.labelframe2,text='Grabar',highlightbackground=self.back1,bg="#59c9b9", fg=self.foreblack, font=self.tamagnoletra)
        #self.button2.grid(column=1, row=linea, padx=4, pady=4)
        ...
        self.listaTree_rol = tkrttk.Treeview(self.frametabla, height="14", selectmode='browse')
        ...
        self.listaTree_rol.column("CONTADOR", width=80, minwidth=270,stretch=tkr.NO)
        self.listaTree_rol.column("TABLA", width=240, minwidth=270,stretch=tkr.NO)
        self.listaTree_rol.column("DESCRIPCION", width=240, minwidth=270,stretch=tkr.NO)
        self.listaTree_rol.column("ORDEN", width=80, minwidth=270,stretch=tkr.NO)
        self.listaTree_rol.column("PADRE", width=80, minwidth=270,stretch=tkr.NO)
